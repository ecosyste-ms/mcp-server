...
class GetPackageMetricsToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Package", GetPackageMetricsTool.category
  end

  test "should have description" do
    assert_not_nil GetPackageMetricsTool.description
    assert_not_empty GetPackageMetricsTool.description
  end

  test "should have input schema" do
    schema = GetPackageMetricsTool.input_schema
  ...
  test "should handle call method" do
    tool = GetPackageMetricsTool.new
