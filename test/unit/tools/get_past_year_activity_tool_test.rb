...
class GetPastYearActivityToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Issues", GetPastYearActivityTool.category
  end

  test "should have description" do
    assert_not_nil GetPastYearActivityTool.description
    assert_not_empty GetPastYearActivityTool.description
  end

  test "should have input schema" do
    schema = GetPastYearActivityTool.input_schema
...
test "should handle call method" do
  tool = GetPastYearActivityTool.new
