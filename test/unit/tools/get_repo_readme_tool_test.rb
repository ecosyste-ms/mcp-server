...
class GetRepoReadmeToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Repository", GetRepoReadmeTool.category
  end

  test "should have description" do
    assert_not_nil GetRepoReadmeTool.description
    assert_not_empty GetRepoReadmeTool.description
  end

  test "should have input schema" do
    schema = GetRepoReadmeTool.input_schema
