...
class GetCommitterListToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Contributors", GetCommitterListTool.category
  end

  test "should have description" do
    assert_not_nil GetCommitterListTool.description
    assert_not_empty GetCommitterListTool.description
  end

  test "should have input schema" do
    schema = GetCommitterListTool.input_schema
