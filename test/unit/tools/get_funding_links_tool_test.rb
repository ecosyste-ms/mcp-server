...
class GetFundingLinksToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Package", GetFundingLinksTool.category
  end

  test "should have description" do
    assert_not_nil GetFundingLinksTool.description
    assert_not_empty GetFundingLinksTool.description
  end

  test "should have input schema" do
    schema = GetFundingLinksTool.input_schema
