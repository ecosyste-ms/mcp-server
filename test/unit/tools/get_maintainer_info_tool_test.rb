...
class GetMaintainerInfoToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Contributors", GetMaintainerInfoTool.category
  end

  test "should have description" do
    assert_not_nil GetMaintainerInfoTool.description
    assert_not_empty GetMaintainerInfoTool.description
  end

  test "should have input schema" do
    schema = GetMaintainerInfoTool.input_schema
...
test "should handle call method" do
  tool = GetMaintainerInfoTool.new
