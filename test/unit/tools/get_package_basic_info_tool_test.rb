...
class GetPackageBasicInfoToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Package", GetPackageBasicInfoTool.category
  end

  test "should have description" do
    assert_not_nil GetPackageBasicInfoTool.description
    assert_not_empty GetPackageBasicInfoTool.description
  end

  test "should have input schema" do
    schema = GetPackageBasicInfoTool.input_schema
...
test "should handle call method" do
  tool = GetPackageBasicInfoTool.new
