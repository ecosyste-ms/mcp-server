...
class GetRepoPackageNamesToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Repository", GetRepoPackageNamesTool.category
  end

  test "should have description" do
    assert_not_nil GetRepoPackageNamesTool.description
    assert_not_empty GetRepoPackageNamesTool.description
  end

  test "should have input schema" do
    schema = GetRepoPackageNamesTool.input_schema
  ...
  test "should handle call method" do
    tool = GetRepoPackageNamesTool.new
