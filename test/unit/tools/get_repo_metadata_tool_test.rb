...
class GetRepoMetadataToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Repository", GetRepoMetadataTool.category
  end

  test "should have description" do
    assert_not_nil GetRepoMetadataTool.description
    assert_not_empty GetRepoMetadataTool.description
  end

  test "should have input schema" do
    schema = GetRepoMetadataTool.input_schema
