...
class GetVersionInfoToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Version", GetVersionInfoTool.category
  end

  test "should have description" do
    assert_not_nil GetVersionInfoTool.description
    assert_not_empty GetVersionInfoTool.description
  end

  test "should have input schema" do
    schema = GetVersionInfoTool.input_schema
