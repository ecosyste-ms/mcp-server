...
class GetPackageVersionsToolTest < ActiveSupport::TestCase
  test "should have correct category" do
    assert_equal "Version", GetPackageVersionsTool.category
  end

  test "should have description" do
    assert_not_nil GetPackageVersionsTool.description
    assert_not_empty GetPackageVersionsTool.description
  end

  test "should have input schema" do
    schema = GetPackageVersionsTool.input_schema
...
test "should handle call method" do
  tool = GetPackageVersionsTool.new
